...
public class Bank extends Node {
    ...
    public boolean validate() {
        ...
        return inventoryOnlyHasBallOfWool || inventoryOnlyHasBowString || Inventory.getAll().length == 0 || (Skills.getActualLevel(Skills.SKILLS.CRAFTING) == 10 && Inventory.find("Flax").length <= 0);
    }
    public void execute() {
